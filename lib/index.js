...
var useIsOnline = function () {
  ...
  var _a = (0, react_1.useState)(window.navigator.onLine),
    isOnline = _a[0],
    setOnlineStatus = _a[1];
  ...
  (0, react_1.useEffect)(function () {
    var setup = function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var currentConnection, toggleOnlineStatus, toggleConnectionStatus, conn;
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [
                          4 /*yield*/,
                          (0, getConnection_1.getConnection)(),
                        ];
                      case 1:
                        connStatus = _a.sent();
