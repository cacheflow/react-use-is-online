...
exports.getConnection = exports.getConnectionEstimate = exports.missingWindow = void 0;
exports.missingWindow = typeof window === 'undefined';
var hasConnectionType = function () {
    var _a;
    return (_a = window === null || window === void 0 ? void 0 : window.navigator) === null || _a === void 0 ? void 0 : _a.connection;
};
...
var getConnection = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                if (exports.missingWindow) {
                    return [2 /*return*/, null];
                }
                if (!!hasConnectionType()) return [3 /*break*/, 2];
                return [4 /*yield*/, getConnectionEstimate()];
            case 1:
                connectionEst = _f.sent();
                return [2 /*return*/, {
                        downlink: (_a = connectionEst.downlink) !== null && _a !== void 0 ? _a : undefined,
                        effectiveType: connectionEst.effectiveType === 'offline'
                            ? undefined
                            : connectionEst.effectiveType,
                        rtt: (_b = connectionEst.rtt) !== null && _b !== void 0 ? _b : undefined,
                        saveData: connectionEst.saveData,
                    }];
            case 2:
                conn = ((_c = window === null || window === void 0 ? void 0 : window.navigator) === null || _c === void 0 ? void 0 : _c.connection) ||
                    ((_d = window === null || window === void 0 ? void 0 : window.navigator) === null || _d === void 0 ? void 0 : _d.mozConnection) ||
                    ((_e = window === null || window === void 0 ? void 0 : window.navigator) === null || _e === void 0 ? void 0 : _e.webkitConnection);
                if (!conn) {
                    return [2 /*return*/, {
                            downlink: undefined,
